...
TEST_OBJS = ${BUILD_DIR}/TesteGerente.o ${BUILD_DIR}/TesteBanco.o \
            ...
            ${BUILD_DIR}/Gerente.o ${BUILD_DIR}/Banco.o ${BUILD_DIR}/ContaPj.o \
            ${BUILD_DIR}/ContaPf.o ${BUILD_DIR}/Conta.o ${BUILD_DIR}/Cliente.o \
            ${BUILD_DIR}/Calendario.o

#----- Build principal -----
${BIN_DIR}/${TARGET}: ${MAIN_OBJS}
	@mkdir -p ${BIN_DIR}
	${CC} ${CFLAGS} ${COVERAGE_FLAGS} ${MAIN_OBJS} -o ${BIN_DIR}/${TARGET}

#----- Build dos testes -----
${BIN_DIR}/${TEST_TARGET}: ${TEST_OBJS}
	@mkdir -p ${BIN_DIR}
	${CC} ${CFLAGS} ${COVERAGE_FLAGS} ${TEST_OBJS} -o ${BIN_DIR}/${TEST_TARGET}

#----- Regras de compilação para os arquivos principais -----
${BUILD_DIR}/%.o: ${SRC_DIR}/%.cpp ${INCLUDE_DIR}/%.hpp
	@mkdir -p ${BUILD_DIR}
	${CC} ${CFLAGS} ${COVERAGE_FLAGS} -I${INCLUDE_DIR} -c $< -o $@

#----- Regras de compilação para os testes -----
${BUILD_DIR}/TesteGerente.o: ${TESTS_DIR}/TesteGerente.cpp
	@mkdir -p ${BUILD_DIR}
	${CC} ${CFLAGS} ${COVERAGE_FLAGS} -I${INCLUDE_DIR} -I${LIB_DIR}/doctest -c $< -o $@
...
coverage:
	@mkdir -p relate 
	gcovr -r . --html --html-details -o relat/relatorio.html